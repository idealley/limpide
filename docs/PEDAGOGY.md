...
## Understanding as the aim

Limpide aims for understanding the student can explain, apply, and revisit independently. Explanation is a central teaching and assessment tool. Learning can include this understanding; the terminology must not imply that listening to an explanation prevents it.

[ADR-0021](ADR/0021-validate-tutoring-first.md) separates durable values from testable methods. The Tutor can question, explain, demonstrate, and correct. Gardner records the teaching route and support, then evaluates what the student demonstrated. Discovery bonuses and assumptions about durability require independent validation; they are not consequences of the vocabulary.

## The two roles

Limpide presents itself to the student as a single entity. Internally it is two:

**The Tutor** runs the session. It is the only voice the student hears. Its job is to ask the student to explain what they think they know, to listen, and to ask the next question. It uses concise explanations and worked examples when useful, and leaves room for productive independent effort. It maintains conversational warmth without sliding into reassurance.

**The Gardner** reads the transcript and extracts structured understanding. It identifies gaps, classifies curiosity signals, evaluates teach-back quality, recognizes cross-substrate moments, and updates the system's model of where the student stands. The student never sees Gardner's output directly. The Tutor reads Gardner's notes at decision points and acts on them — while offering clear, respectful corrective feedback when it helps.

This split is structural, not cosmetic. The Tutor's job is conversational; the Gardner's job is analytic. The split keeps raw analytic notes separate from the teaching conversation; it does not prohibit useful feedback.
...
**Struggle.** The student attempts independently. The Tutor allows useful effort and watches for progress, frustration, or a request for help. After a short unproductive exchange, offer a hint, worked example, or explanation; two to four turns is a provisional ceiling, not a required struggle quota. If the student solves the problem, use a brief reasoning check before recording evidence of understanding. A correct answer alone does not bypass F10.

**Teach.** Two distinct moves in one state. First, *bridge*: name what just happened. "You noticed X but couldn't get past Y — that's exactly what this concept is for." This is the moment of receptivity and most teachers skip it. Second, *deliver*: present the theory in the channel that fits the student. Prefer connecting the explanation to what the student noticed. When useful, name a misconception directly and respectfully; do not prolong confusion just to preserve discovery.
...
3. *Probe or correct as useful.* A question can help a student inspect an error. "You're saying multiplying two negatives flips the sign — why does that have to be true?" If questioning does not help, offer a clear correction and invite a fresh attempt. Record the support rather than labeling the response an independent discovery.
...
**Discovered understanding** is what the student arrives at by working through the material themselves. The Tutor asked, the student explained, the student hit a wall, the student found their way through. The theory was present in the student's response before the Tutor named it. Record the independent reasoning demonstrated; lasting benefit requires later evidence.

**Delivered understanding** is what the system gave the student because that's what they needed. The student declined the fork, or asked directly for the answer, or was running out of time. The theory was given; the student accepted it; they may or may not be able to apply it. The explanation itself does not raise confidence. A subsequent independent demonstration can provide strong evidence regardless of how the idea was taught.
...
The system is honest with itself about which kind of learning just happened. Going through five concepts, by either route, does not establish mastery. Revisit uncertain concepts and check independent application later. The distinction must survive into the data — confidence is not a single number, it's a weighted history of how each encounter went.
...
**F1. Help the student notice; provide timely help.** Prefer questions that let the student inspect their own reasoning. When probing is unproductive, or direct help is requested, explain or correct clearly. Preserve dignity and agency without requiring discovery before every explanation. Amended by ADR-0021.

**F2. Distinguish independent demonstration from supplied content.** Repeating the Tutor's explanation is weaker evidence than independently explaining or applying the idea. Record the teaching route and support, but do not assign an intrinsic discovery bonus or assume slower forgetting by decree. Evidence after explicit instruction can demonstrate understanding. Amended by ADR-0021.
...
- Does not impose a placement test on someone seeking immediate help. An optional, low-stakes placement session is appropriate for a learner choosing a recurring practice program; it provides tentative starting points, not a global ability label.
...
- **Eliminating every difficulty.** Useful effort belongs in learning, but persistent frustration calls for help. The method must adapt to the learner.
...
**Settled.** The two-role architecture (Tutor and Gardner). The six-state session loop. The recursive stack model for forks. The discovered/delivered/forced distinction. The Foundation rules F1–F12 (pending the architectural translation in the Policy Gate spec; F11 added via ADR-0012, F12 via ADR-0014, F1/F2 amended by ADR-0021). The opening turn pattern.

**Tentative.** Which balance of questioning, explicit teaching, and practice helps each learner. The placement and daily-practice format (`BOOTSTRAP-PILOT.md`). The specific cooldown durations (24 hours, 7 days, 21 days, 60 days). The strategy-selection rules for Gardner when pinning gaps. The exact threshold for "sufficiently solid" prerequisites in the Select state. These will be calibrated as real students use the system.
