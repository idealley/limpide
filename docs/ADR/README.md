...
| [0009](0009-probe-gating.md) | Probe gating — deterministic policy over learned strategy | Proposed, amended by 0021 |
...
| [0012](0012-expressive-baseline.md) | Expressive baseline — measuring understanding relative to expected articulation | Proposed, amended by 0021 |
| [0013](0013-canonical-graph-and-overlays.md) | Canonical concept graph and curriculum overlays | Proposed, clarified by 0021 |
...
| [0016](0016-system-evaluation.md) | Evaluating the system | Proposed, amended by 0021 |
| [0017](0017-latency-cost-budget.md) | Latency and cost budget for the interactive path | Proposed |
| [0018](0018-confidence-model.md) | The confidence model | Proposed, amended by 0021 |
